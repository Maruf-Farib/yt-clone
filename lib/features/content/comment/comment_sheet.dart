...
import 'package:yt/features/content/comment/comment_tile.dart';
import 'package:yt/features/upload/comments/comment_model.dart';
import 'package:yt/features/upload/comments/comment_repository.dart';
          ...
          StreamBuilder(
            ...
            builder: (context, snapshot) {
              ...
              final List<CommentModel> comments =
                  commentsMap.map((comment) => CommentModel.fromMap(comment.data())).toList();
              return Expanded(
